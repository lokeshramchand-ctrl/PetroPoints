...
import DashboardSidebar from './Sidebar'; // Kept exactly as you requested
...
export default function LoyaltyAdminDashboard() {
  ...
  useEffect(() => {
    setSuccessMessage(''); // Clear success on new input
    ...
    const timer = setTimeout(() => {
      ...
      setIsLoading(false);
    }, 600); // slightly longer debounce for a realistic feel
  ...
  const handleSubmit = (e: FormEvent) => {
    ...
    setError('');
    setSuccessMessage(`Successfully awarded ${points} points to vehicle!`);
          ...
          <section className="form-panel">
            ...
            <form onSubmit={handleSubmit} className="form-grid">
              ...
              <button
                ...
                disabled={!isValidUser || !points || isLoading || !selectedVehicle}
              >
                Award Points
