          ...
          <div className="page-container">
            ...
            <section className="form-wrapper">
              <div className="form-header">
                ...
                <p className="form-subtitle">Enter customer details and redeem points from the selected vehicle.</p>
              </div>
              ...
              <form onSubmit={handleSubmit} className="form-grid">
                ...
                <div className="form-group">
                  <label className="form-label" htmlFor="points">Points to be Redeem</label>
                  <input
                    id="points"
                    className="form-input"
                    type="number"
                    ...
                    onChange={(event) => setPointsToRedeem(event.target.value ? Number(event.target.value) : '')}
                    required
                  />
                </div>
